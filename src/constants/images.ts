...
import bawoMark from "../assets/images/bawo-mark.png";
...
export const IMAGES = {
  ...
  assets: {
    ...
    /** Mark only — orange→eggplant bean, transparent cutout for header */
    mark: bawoMark,
    logoOld: bawoLogo,
  ...
  globalReach: {
    ...
    cities: [bkBrooklyn01, hm01, qn01, bx01, si01],
    cityMeta: [
  ...
  placeholders: {
    avatar:
      "https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=96&q=80&auto=format&fit=crop",
    feature:
      "https://images.unsplash.com/photo-1556157382-97eda2d62296?w=768&q=80&auto=format&fit=crop",
    event:
      "https://images.unsplash.com/photo-1545239351-1141bd82e8a6?w=800&q=80&q=80&auto=format&fit=crop",
  },
